      ...
      if(NB2.IsNewBar(_Symbol,_Period) && QtdeStops()<qtdestops)
        {
         if(PositionsTotal()==0)
         ...
         else
           {
            if(martpontos==true)
              {
               if(PossuiPosCompraComentada("C1") && !PossuiPosCompraComentada("C2") && tick.ask<PrecoAberturaPosCompra(1)-pontos2*_Point && VolumePos()<=500 && volnv2!=0)
                 {
                  trade.Buy(volnv2,_Symbol,tick.ask,puxatpsl("SLC1"),tick.ask+pontosc2*_Point,"C2");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosCompraComentada("C2") && !PossuiPosCompraComentada("C3") && tick.ask<PrecoAberturaPosCompra(1)-pontos3*_Point && VolumePos()<=500 && volnv3!=0)
                 {
                  trade.Buy(volnv3,_Symbol,tick.ask,puxatpsl("SLC2"),tick.ask+pontosc3*_Point,"C3");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosCompraComentada("C3") && !PossuiPosCompraComentada("C4") && tick.ask<PrecoAberturaPosCompra(1)-pontos4*_Point && VolumePos()<=500 && volnv4!=0)
                 {
                  trade.Buy(volnv4,_Symbol,tick.ask,puxatpsl("SLC3"),tick.ask+pontosc4*_Point,"C4");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosCompraComentada("C4") && !PossuiPosCompraComentada("C5") && tick.ask<PrecoAberturaPosCompra(1)-pontos5*_Point && VolumePos()<=500 && volnv5!=0)
                 {
                  trade.Buy(volnv5,_Symbol,tick.ask,puxatpsl("SLC4"),tick.ask+pontosc5*_Point,"C5");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosCompraComentada("C5") && !PossuiPosCompraComentada("C6") && tick.ask<PrecoAberturaPosCompra(1)-pontos6*_Point && VolumePos()<=500 && volnv6!=0)
                 {
                  trade.Buy(volnv6,_Symbol,tick.ask,puxatpsl("SLC5"),tick.ask+pontosc6*_Point,"C6");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosCompraComentada("C6") && !PossuiPosCompraComentada("C7") && tick.ask<PrecoAberturaPosCompra(1)-pontos7*_Point && VolumePos()<=500 && volnv7!=0)
                 {
                  trade.Buy(volnv7,_Symbol,tick.ask,puxatpsl("SLC6"),tick.ask+pontosc7*_Point,"C7");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosCompraComentada("C7") && !PossuiPosCompraComentada("C8") && tick.ask<PrecoAberturaPosCompra(1)-pontos8*_Point && VolumePos()<=500 && volnv8!=0)
                 {
                  trade.Buy(volnv8,_Symbol,tick.ask,puxatpsl("SLC7"),tick.ask+pontosc8*_Point,"C8");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosVendaComentada("V1") && !PossuiPosVendaComentada("V2") && tick.bid>PrecoAberturaPosVenda(1)+pontos2*_Point && VolumePos()<=500 && volnv2!=0)
                 {
                  trade.Sell(volnv2,_Symbol,tick.bid,puxatpsl("SLV1"),tick.bid-pontosc2*_Point,"V2");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosVendaComentada("V2") && !PossuiPosVendaComentada("V3") && tick.bid>PrecoAberturaPosVenda(1)+pontos3*_Point && VolumePos()<=500 && volnv3!=0)
                 {
                  trade.Sell(volnv3,_Symbol,tick.bid,puxatpsl("SLV2"),tick.bid-pontosc3*_Point,"V3");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosVendaComentada("V3") && !PossuiPosVendaComentada("V4") && tick.bid>PrecoAberturaPosVenda(1)+pontos4*_Point && VolumePos()<=500 && volnv4!=0)
                 {
                  trade.Sell(volnv4,_Symbol,tick.bid,puxatpsl("SLV3"),tick.bid-pontosc4*_Point,"V4");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosVendaComentada("V4") && !PossuiPosVendaComentada("V5") && tick.bid>PrecoAberturaPosVenda(1)+pontos5*_Point && VolumePos()<=500 && volnv5!=0)
                 {
                  trade.Sell(volnv5,_Symbol,tick.bid,puxatpsl("SLV4"),tick.bid-pontosc5*_Point,"V5");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosVendaComentada("V5") && !PossuiPosVendaComentada("V6") && tick.bid>PrecoAberturaPosVenda(1)+pontos6*_Point && VolumePos()<=500 && volnv6!=0)
                 {
                  trade.Sell(volnv6,_Symbol,tick.bid,puxatpsl("SLV5"),tick.bid-pontosc6*_Point,"V6");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosVendaComentada("V6") && !PossuiPosVendaComentada("V7") && tick.bid>PrecoAberturaPosVenda(1)+pontos7*_Point && VolumePos()<=500 && volnv7!=0)
                 {
                  trade.Sell(volnv7,_Symbol,tick.bid,puxatpsl("SLV6"),tick.bid-pontosc7*_Point,"V7");
                  Sleep(500);
                  return;
                 }
               if(PossuiPosVendaComentada("V7") && !PossuiPosVendaComentada("V8") && tick.bid>PrecoAberturaPosVenda(1)+pontos8*_Point && VolumePos()<=500 && volnv8!=0)
                 {
                  trade.Sell(volnv8,_Symbol,tick.bid,puxatpsl("SLV7"),tick.bid-pontosc8*_Point,"V8");
                  Sleep(500);
                  return;
                 }
              }
...
void  ComprasNormais()
  {
   ...
   if(PossuiPosCompraComentada("C1") && !PossuiPosCompraComentada("C2") && tick.ask<PrecoAberturaPosCompra(1)-pontos2*_Point/*&& tick.ask<PrecoAberturaPosCompra(1)-ptsmartprimcompra*_Point*/ //
   ...
   if(PossuiPosCompraComentada("C2") && !PossuiPosCompraComentada("C3") && tick.ask<PrecoAberturaPosCompra(1)-pontos3*_Point/*&& (PrecoAberturaPosCompra(1)-tick.ask)/_Point> //
   ...
   if(PossuiPosCompraComentada("C3") && !PossuiPosCompraComentada("C4") && tick.ask<PrecoAberturaPosCompra(1)-pontos4*_Point/*&& (PrecoAberturaPosCompra(1)-tick.ask)/_Point> //
   ...
   if(PossuiPosCompraComentada("C4") && !PossuiPosCompraComentada("C5") && tick.ask<PrecoAberturaPosCompra(1)-pontos5*_Point/*&& (PrecoAberturaPosCompra(1)-tick.ask)/_Point> //
   ...
   if(PossuiPosCompraComentada("C5") && !PossuiPosCompraComentada("C6") && tick.ask<PrecoAberturaPosCompra(1)-pontos6*_Point/*&& (PrecoAberturaPosCompra(1)-tick.ask)/_Point> //
   ...
   if(PossuiPosCompraComentada("C6") && !PossuiPosCompraComentada("C7") && tick.ask<PrecoAberturaPosCompra(1)-pontos7*_Point/*&& (PrecoAberturaPosCompra(1)-tick.ask)/_Point> //
   ...
   if(PossuiPosCompraComentada("C7") && !PossuiPosCompraComentada("C8") && tick.ask<PrecoAberturaPosCompra(1)-pontos8*_Point/*&& (PrecoAberturaPosCompra(1)-tick.ask)/_Point> //
...
void  VendasNormais()
  {
   ...
   if(PossuiPosVendaComentada("V1") && !PossuiPosVendaComentada("V2") && tick.bid>PrecoAberturaPosVenda(1)+pontos2*_Point/*&& tick.bid>PrecoAberturaPosVenda(1)+ptsmartprimcompra*_Point*///
      && VolumePos()<=500 && volnv2!=0)
     {
   ...
   if(PossuiPosVendaComentada("V2") && !PossuiPosVendaComentada("V3") && tick.bid>PrecoAberturaPosVenda(1)+pontos3*_Point/*&& (tick.bid-PrecoAberturaPosVenda(1))/_Point> //
   ...
   if(PossuiPosVendaComentada("V3") && !PossuiPosVendaComentada("V4") && tick.bid>PrecoAberturaPosVenda(1)+pontos4*_Point/*&& (tick.bid-PrecoAberturaPosVenda(1))/_Point> //
   ...
   if(PossuiPosVendaComentada("V4") && !PossuiPosVendaComentada("V5") && tick.bid>PrecoAberturaPosVenda(1)+pontos5*_Point/*&& (tick.bid-PrecoAberturaPosVenda(1))/_Point> //
   ...
   if(PossuiPosVendaComentada("V5") && !PossuiPosVendaComentada("V6") && tick.bid>PrecoAberturaPosVenda(1)+pontos6*_Point/*&& (tick.bid-PrecoAberturaPosVenda(1))/_Point> //
   ...
   if(PossuiPosVendaComentada("V6") && !PossuiPosVendaComentada("V7") && tick.bid>PrecoAberturaPosVenda(1)+pontos7*_Point/*&& (tick.bid-PrecoAberturaPosVenda(1))/_Point> //
   ...
   if(PossuiPosVendaComentada("V7") && !PossuiPosVendaComentada("V8") && tick.bid>PrecoAberturaPosVenda(1)+pontos8*_Point/*&& (tick.bid-PrecoAberturaPosVenda(1))/_Point> //
