...
//+-----------------------------+
   ...
   if(ativatendencia)
     {
      double var01 = NormalizeDouble(((ticks[1].ask-ticks[0].ask)/ticks[0].ask*100),6);
      double var02 = NormalizeDouble(((ticks[2].ask-ticks[0].ask)/ticks[0].ask*100),6);
      double var03 = NormalizeDouble(((ticks[3].ask-ticks[0].ask)/ticks[0].ask*100),6);
      double var04 = NormalizeDouble(((ticks[4].ask-ticks[0].ask)/ticks[0].ask*100),6);
      double var05 = NormalizeDouble(((ticks[5].ask-ticks[0].ask)/ticks[0].ask*100),6);
      Print("ticks01: ",var01," ticks02: ",var02," ticks03: ",var03," ticks04: ",var04," ticks05: ",var05);
     }
