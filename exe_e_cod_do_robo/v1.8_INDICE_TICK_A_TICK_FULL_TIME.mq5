...
//--- Prepara os Handles necessários segundo a estratégia escolhida
   if(estrategia==estrat1 || estrategia==estrat2 || estrategia==estrat5 || estrategia==estrat7 || estrategia==estrat11 || estrategia==estrat16)
     {
   ...
   if(estrategia==estrat4 || estrategia==estrat9 || estrategia==estrat14 || estrategia==estrat16)
     {
      ...
      if((possuicompra && sarnormalizado0>tick.bid)||(possuivenda && sarnormalizado0<tick.ask))
        {
         ...
         if(sarnormalizado0 < tick.ask)
           {
            trade.Buy(2,_Symbol,tick.ask,puxatpsl("SLC0"),0,"C2");
           }
         if(sarnormalizado0 > tick.bid)
           {
            trade.Sell(2,_Symbol,tick.bid,puxatpsl("SLV0"),0,"V2");
           }
        }
     }
      ...
      if(PositionsTotal()==0 /*&& mitigacaook*/)
        {
         ...
         //---| ESTRATEGIA SAR/RSI |---//
         if(estrategia==estrat16)
           {
            if(sarnormalizado0 < tick.ask && rsi[0]<sobrevrsi/* && sarnormalizado1 < tick.ask*/)
               trade.Buy(volumeoper,_Symbol,tick.ask,puxatpsl("SLC0"),0,"C1");
            Sleep(100);
            if(sarnormalizado0 > tick.bid && rsi[0]>sobrecrsi/* && sarnormalizado1 > tick.bid*/)
               trade.Sell(volumeoper,_Symbol,tick.bid,puxatpsl("SLV0"),0,"V1");
            Sleep(100);
           }
