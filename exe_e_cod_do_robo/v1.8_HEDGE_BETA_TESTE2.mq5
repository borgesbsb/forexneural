...
////////////////////////////////////////////
   if(ativafecfinaldia && PositionsTotal()>=1)
     {
...
///////////////////////////////////////////////////
   if(fechaordensnozero && PositionsTotal()>=1)
     {
      FechaOrdensNozero();
     }
            ...
            if(estrategia==estrat6)
              {
               ...
               if(candle[1].close<mm[1]-tamanhoenvelope*_Point && probcompra>percentteste)
                  trade.Buy(volumeoper,_Symbol,tick.ask,puxatpsl("SLC0"),puxatpsl("TPC0"),"C1");
              }
            //---| ESTRATEGIA RSI |---//
            ...
            if(estrategia==estrat13)
              {
               ...
               if(previsao > tick.ask && previsao != 0 && candle[1].close<mm[1]-tamanhoenvelope*_Point && probcompra>percentteste)
                  trade.Buy(volumeoper,_Symbol,tick.ask,puxatpsl("SLC0"),puxatpsl("TPC0"),"C1");
              }
            ...
            if(estrategia==estrat6)
              {
               ...
               if(candle[1].close>mm[1]+tamanhoenvelope*_Point && probvenda>percentteste)
                  trade.Sell(volumeoper,_Symbol,tick.bid,puxatpsl("SLV0"),puxatpsl("TPV0"),"V1");
              }
            //---| ESTRATEGIA RSI |---//
            if(estrategia==estrat7)
            ...
            if(estrategia==estrat13)
              {
               ...
               if(previsao > tick.ask && previsao != 0 && candle[1].close<mm[1]-tamanhoenvelope*_Point && probcompra>percentteste)
                  ComprasMartingale();
               if(previsao < tick.bid && previsao !=0 && candle[1].close>mm[1]+tamanhoenvelope*_Point && probvenda>percentteste)
                  VendasMartingale();
              }
            //---| ESTRATEGIA NEURAL/SAR |---//
            if(estrategia==estrat14)
...
/////////////////////////////////
   /*   if(ativasaidaea==true)
        {
         if(PosAberta("POSSUI","COMPRA","C1") && tick.bid>DadosPos("PREÇO DA ÚLTIMA POSIÇÃO ABERTA","COMPRA")+pontosc1*_Point)
            FechaTodasPosicoesAbertas();

         if(PosAberta("POSSUI","VENDA","V1") && tick.ask<DadosPos("PREÇO DA ÚLTIMA POSIÇÃO ABERTA","VENDA")-pontosc1*_Point)
            FechaTodasPosicoesAbertas();
        }
        */
   ...
   if(tipo=="COMPRA")
     {
      ...
      percentfavorcompra = favoravelcompra/qtdecandlestend*100;
     }
   ...
   if(tipo=="VENDA")
     {
      ...
      percentfavorvenda = favoravelvenda/qtdecandlestend*100;
     }
