...
best_accuracy = 0
save_to_csv   = None
variables_saves = ['best_neurons','best_epochs','best_accuracy','loop_epochs' , 'neurons_i','epochs_i','variables_saves','save_to_csv','mes','ano']
                ...
                for loop_epochs in range(3):
                    ...
                    class Training:
                        ...
                        def saveLSTM(self):
                            ...
                            with open("scaler_x.pkl", "wb") as scaler_x:
                                pkl.dump(self.ds.scaler_x, scaler_x)
                            with open("scaler_y.pkl", "wb") as scaler_y:
                    ...
                    class Testing:
                        ...
                        def estatistical(self):
                            ...
                            self.time_validate  = pd.DataFrame(data=self.ds.df_validate['time'].shift(-4).dropna().values, columns=['Data'])
