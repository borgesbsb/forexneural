      ...
      if(!(HorarioPausa1() || HorarioPausa2()))
         ...
         */
         ...
         if(ativaentradaea==true && (percent_margem>prctniveloper||saldo==capital) && !PossuiPosAbertaOutroAtivo())
           {
            if(previsao > Ask && previsao!=0.0 && rsi[0]<30 && !PossuiPosCompra() && !PossuiPosVenda())
              {
            ...
            if(previsao < Bid && previsao!=0.0 && rsi[0]>70 && !PossuiPosCompra() && !PossuiPosVenda())
              {
               ExcluiOrdensPendentes();
...
//////////////////////////
   //if(ativastop==true)
   //   if(lucro_prejuizo>=0-LucroPrejuizoPosAberta() && saldo!=capital)
   //      FechaTodasPosicoesAbertas();
